...
public class SmsApplay implements Serializable {
	...
	private String appointmentTimeDes;
	private String createDatetimeDes;
	...
	public String getAppointmentTimeDes() {
		return appointmentTimeDes;
	}
	public String getCreateDatetimeDes() {
		return createDatetimeDes;
	}
	...
	public void setAppointmentTimeDes(String appointmentTimeDes) {
		this.appointmentTimeDes = appointmentTimeDes;
	}
	public void setCreateDatetimeDes(String createDatetimeDes) {
		this.createDatetimeDes = createDatetimeDes;
	}
	@Override
	public String toString() {
		return "SmsApplay [smsApplayId=" + smsApplayId + ", batchNo=" + batchNo + ", batchType=" + batchType
				...
				+ createDatetime + ", operator=" + operator + ", signTip=" + signTip + ", batchTypeDes=" + batchTypeDes
				+ ", accountTypeDes=" + accountTypeDes + ", orderFlagDes=" + orderFlagDes + ", applayStatusDes="
				+ applayStatusDes + ", appointmentTimeDes=" + appointmentTimeDes + ", createDatetimeDes="
				+ createDatetimeDes + "]";
	}
}