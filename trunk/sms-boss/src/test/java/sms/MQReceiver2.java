...
public class MQReceiver2 {
	...
	private static final Logger logger = LoggerFactory.getLogger(MQReceiver2.class);
...
//			 message.acknowledge();
			...
			while (true) {
				...
				TextMessage message = (TextMessage) consumer.receive();
				if (null != message) {
					System.out.println("=====>>>>MQReceiver2 " + message.getText());
				} else {
					break;
				}
			}
	...
	public static void main(String[] args) {
		MQReceiver2 jms = new MQReceiver2();
		jms.init();
	}
