...
public class Channel implements Serializable{
	...
	private String supportOperatorsDes;    //支持运营商 100 - 电信 200 - 联通 300 - 移动 400 - 全网通 500-第三方 600-其他
	private Integer channelStatus;    //通道状态100 - 使用 200 - 禁用
	private String channelStatusDes;    //通道状态100 - 使用 200 - 禁用
	private String createDatetime;    //创建时间
	private String remark;    //备注
	private Integer channelType;    //通道类型 100-短信 200-彩信 300-语音
	private String channelTypeDes;    //通道类型 100-短信 200-彩信 300-语音
	private Integer payMethod ;    //付费方式 100-预付费 200-后付费
	private String payMethodDes ;    //付费方式 100-预付费 200-后付费
