...
//            return new String(byteDatas) + "`" + httpStatusCode;
    ...
    public static String httpPost(String uri, List <NameValuePair> nvps) {
    	String respStr = null;
        ...
        try {
            ...
            System.out.println("HttpClientUtil.httpPost-ResponseCode:" + response2.getStatusLine());
            ...
            if (entity2 != null){
    			...
    			reader.close();// 关闭输入流
    			respStr = URLDecoder.decode(reqStr.toString(), "UTF-8");
            }
        } catch(Exception e) {
        	e.printStackTrace();
    	} finally {
