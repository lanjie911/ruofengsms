...
public class DatetimeUtil {
	...
	public static String getCurrentDate() {
		...
		return dateForamt.format(new java.util.Date());
	}
	...
	public static String getCurrentFullTime() {
		SimpleDateFormat timeForamt = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		return timeForamt.format(new java.util.Date());
	}
	...
	public static String getCurrentMonthDay() {
		SimpleDateFormat dateForamt = new SimpleDateFormat("MMdd");
		return dateForamt.format(new java.util.Date());
	}
	 ...
	 * @param startTime 时间字符串
	 * @param endTime 时间字符串
	 * @param dateformat 时间比较格式 yyyy-MM-dd HH:mm:ss 或 yyyyMMddHHmmss
	 * @return  -1:endTimed大  0:相等 1:startTime大
	 */
	public static Integer compareTime(String startTime, String endTime,String dateformat){
		Integer compareResult = 0;
		try {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(getCurrentFullTime3());
...
//			System.out.println(""+day+"天"+hour+"小时"+min+"分"+s+"秒");
	...
	public static String stringDate2StringDATE(String str) throws ParseException {
     ...
     * @throws Exception 
     */  
	public static String getSpecifiedDayBefore(Date date, String formatStr) {//可以用new Date().toLocalString()传递参数  
     ...
     * @return 
     */  
    public static String getSpecifiedDayAfter(Date date, String formatStr) {  
        Calendar c = Calendar.getInstance();  
        c.setTime(date);  
        int day = c.get(Calendar.DATE);  
        c.set(Calendar.DATE, day + 1);  
